...
x = 0
neglobal = 1 #nemuze byt klicove slovo
PI = 3.14159265358979323846264338327950288419716939937510582097494459230781640628620899862803482534211706798214808651 #mohou mit libovolnou delku
city = 'Opava'
HildaDokonalá = 'hilda@sspu-opava.cz' #identifier nesí obsahovat symboly
password2 = 'TajneHeslo'
agent007 = 'James Bond' #nemuze zacinat cislem
